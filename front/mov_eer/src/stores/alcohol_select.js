    ...
    const beers = ref([
      {
        ...
        imageUrl: "http://127.0.0.1:8000/media/beer_images/asahi_super_dry.jpg",
      ...
      },
      {
        ...
        imageUrl: "http://127.0.0.1:8000/media/beer_images/oharas_irish_stout.jpg",
      ...
      {
        name: "Blanc",
        imageUrl: "http://127.0.0.1:8000/media/beer_images/kronenbourg_1664_blanc.jpg",
      ...
      },
      {
        ...
        imageUrl: "http://127.0.0.1:8000/media/beer_images/weihenstephaner_hefeweissbier.jpg",
    ...
    const whisky = ref([
      {
        ...
        imageUrl: "http://127.0.0.1:8000/media/whiskey_images/balvenie_doublewood_12_year_old.jpg",
      ...
      },
      {
        ...
        imageUrl: "http://127.0.0.1:8000/media/whiskey_images/glenfiddich_12_year_old.jpg",
      ...
      {
        name: "Hibiki Harmony",
        imageUrl: "http://127.0.0.1:8000/media/whiskey_images/hibiki_harmony.jpg",
      ...
      },
      {
        ...
        imageUrl: "http://127.0.0.1:8000/media/whiskey_images/jack_daniels_single_barrel.jpg",
      ...
      },
      {
        ...
        imageUrl: "http://127.0.0.1:8000/media/whiskey_images/jameson_irish_whiskey.jpg",
      ...
      {
        name: "Maker's Mark",
        imageUrl: "http://127.0.0.1:8000/media/whiskey_images/makers_mark.jpg",
    ...
    const wine = ref([
      {
        ...
        imageUrl: "http://127.0.0.1:8000/media/wine_images/cabernet_sauvignon_robert_mondavi_napa_valley.jpg",
      ...
      },
      {
        ...
        imageUrl: "http://127.0.0.1:8000/media/wine_images/champagne_moet__chandon_brut_imperial.jpg",
      ...
      },
      {
        ...
        imageUrl: "http://127.0.0.1:8000/media/wine_images/chardonnay_louis_latour_pouillyfuisse.jpg",
      ...
      },
      {
        ...
        imageUrl: "http://127.0.0.1:8000/media/wine_images/miraval_rose_provence.jpg",
      ...
      },
      {
        ...
        imageUrl: "http://127.0.0.1:8000/media/wine_images/pinot_noir_domaine_de_la_romaneeconti.jpg",
